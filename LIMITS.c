...
/*printf("\nLLONG_MIN        |   %d       | %X            | ", LLONG_MIN, LLONG_MIN); pbf_inv (LLONG_MIN);
printf("\nLLONG_MAX        |   %d        | %X            | ", LLONG_MAX, LLONG_MAX); pbf_inv (LLONG_MAX);
printf("\nULLONG_MAX         |   %u        | %X            | ", ULLONG_MAX, ULLONG_MAX); pbf_inv (ULLONG_MAX);*/
